# PlayerHasUnitType.Behave Method 
...
#### Return Value
Type: BehaviorReturnCode<br />\[Missing <returns> documentation for "M:EmptyKeys.Strategy.AI.Components.ConditionsPlayer.PlayerHasUnitType.Behave(EmptyKeys.Strategy.AI.IBehaviorContext)"\]
