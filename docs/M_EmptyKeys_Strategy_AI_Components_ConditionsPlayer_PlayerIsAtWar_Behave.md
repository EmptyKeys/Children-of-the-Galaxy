...
#### Return Value
Type: BehaviorReturnCode<br />\[Missing <returns> documentation for "M:EmptyKeys.Strategy.AI.Components.ConditionsPlayer.PlayerIsAtWar.Behave(EmptyKeys.Strategy.AI.IBehaviorContext)"\]
