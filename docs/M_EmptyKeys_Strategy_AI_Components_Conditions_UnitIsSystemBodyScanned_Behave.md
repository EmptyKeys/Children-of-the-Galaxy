# UnitIsSystemBodyScanned.Behave Method 
...
#### Return Value
Type: BehaviorReturnCode<br />\[Missing <returns> documentation for "M:EmptyKeys.Strategy.AI.Components.Conditions.UnitIsSystemBodyScanned.Behave(EmptyKeys.Strategy.AI.IBehaviorContext)"\]
