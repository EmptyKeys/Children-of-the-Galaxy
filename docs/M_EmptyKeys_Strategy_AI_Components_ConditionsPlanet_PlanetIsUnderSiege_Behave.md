# PlanetIsUnderSiege.Behave Method 
...
#### Return Value
Type: BehaviorReturnCode<br />\[Missing <returns> documentation for "M:EmptyKeys.Strategy.AI.Components.ConditionsPlanet.PlanetIsUnderSiege.Behave(EmptyKeys.Strategy.AI.IBehaviorContext)"\]
