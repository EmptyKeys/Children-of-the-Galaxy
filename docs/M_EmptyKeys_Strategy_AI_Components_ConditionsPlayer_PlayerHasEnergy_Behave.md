...
#### Return Value
Type: BehaviorReturnCode<br />\[Missing <returns> documentation for "M:EmptyKeys.Strategy.AI.Components.ConditionsPlayer.PlayerHasEnergy.Behave(EmptyKeys.Strategy.AI.IBehaviorContext)"\]
