# PlanetBuildFactoryItem.Behave Method 
...
#### Return Value
Type: BehaviorReturnCode<br />\[Missing <returns> documentation for "M:EmptyKeys.Strategy.AI.Components.ActionsPlanet.PlanetBuildFactoryItem.Behave(EmptyKeys.Strategy.AI.IBehaviorContext)"\]
