# PlayerHasFactoryItem.Behave Method 
...
#### Return Value
Type: BehaviorReturnCode<br />\[Missing <returns> documentation for "M:EmptyKeys.Strategy.AI.Components.ConditionsPlayer.PlayerHasFactoryItem.Behave(EmptyKeys.Strategy.AI.IBehaviorContext)"\]
