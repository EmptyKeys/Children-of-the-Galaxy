# PlanetIsUnitOnOrbit.Behave Method 
...
#### Return Value
Type: BehaviorReturnCode<br />\[Missing <returns> documentation for "M:EmptyKeys.Strategy.AI.Components.ConditionsPlanet.PlanetIsUnitOnOrbit.Behave(EmptyKeys.Strategy.AI.IBehaviorContext)"\]
