# PlayerSetTradeRoute.Behave Method 
...
#### Return Value
Type: BehaviorReturnCode<br />\[Missing <returns> documentation for "M:EmptyKeys.Strategy.AI.Components.ActionsPlayer.PlayerSetTradeRoute.Behave(EmptyKeys.Strategy.AI.IBehaviorContext)"\]
