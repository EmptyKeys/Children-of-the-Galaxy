# PlayerNeedsTradeShip.Behave Method 
...
#### Return Value
Type: BehaviorReturnCode<br />\[Missing <returns> documentation for "M:EmptyKeys.Strategy.AI.Components.ConditionsPlayer.PlayerNeedsTradeShip.Behave(EmptyKeys.Strategy.AI.IBehaviorContext)"\]
